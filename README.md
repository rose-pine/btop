...
2. Copy / move all the desired themes to `$XDG_CONFIG_HOME/btop/themes`

> **Note** : If `$XDG_CONFIG_HOME/btop/themes` is not set or empty, it will default to `~/.config`

3. Launch btop and press <kbd>Esc</kbd>, then select "Options"
